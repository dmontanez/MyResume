...
public class Main extends ActionBarActivity implements OnItemClickListener {
	...
	// Other declarations.
	private ActionBarDrawerToggle drawerListener; // listener for the drawer;
													// handles the toggling.
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		drawerListener = new ActionBarDrawerToggle(this, drawerLayout,
			...
			@Override
			// What to do when the drawer is opened.
			public void onDrawerOpened(View drawerView) {
				super.onDrawerOpened(drawerView);
				supportInvalidateOptionsMenu();
				Log.d("DMONT", "Sliding Drawer is: ");
			}

			@Override
			// What to do when the drawer is closed.
		...
		drawerLayout.setDrawerListener(drawerListener); // Set the layout object
														// listener.
		...
		getSupportActionBar().setHomeButtonEnabled(true); // Enables the app
															// icon home button.
		getSupportActionBar().setDisplayHomeAsUpEnabled(true); // Displays the
																// up directory
																// indicator to
																// the left of
																// the icon.
	...
	@Override
	// Allows home button to open Navigation Drawer if applicable.
	...
	@Override
	// Lets the system change the Navigation Drawer configuration when needed.
	...
	@Override
	// Sync the state of the navigation drawer.
	...
	@Override
	// Handles the Navigation drawer item click.
	...
	public void onBackPressed() {
		Log.d("DMONT", "Sliding Drawer is: " + drawerLayout.isDrawerOpen(slidingDrawer));
		if (drawerLayout.isDrawerOpen(slidingDrawer) == true) {
	...
	// Sets the Action bar title to the title of the navigation button that was
	// clicked.
	private void selectItem(int position) {
		...
		if (fragment != null && position < 6) {
			...
			Log.e("DMONT", "Error in creating fragment");
		}
		
	}
	
	public void onOpenLeftDrawer(View view) {
		drawerLayout.openDrawer(slidingDrawer);
	}
	
	public void onCloseLeftDrawer(View view) {
		drawerLayout.closeDrawers();
	}
}